...
const FindWalkersSection = () => {
  ...
  return (
    <section id="find-walkers" className="py-16 px-4 bg-white">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Search Panel */}
          <div className="lg:w-1/3">
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 sticky top-8">
              <h2 className="text-2xl font-bold mb-6">Find Dog Walkers Near You</h2>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="boarding">Overnight Care</option>
                    </select>
          ...
          <div className="lg:w-2/3">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold">
                {walkers.length} caregivers available
              </h2>
              <div className="flex items-center">
                  ...
                  <div className="p-5 flex flex-col md:flex-row gap-4">
                    ...
                    <div className="md:w-3/4">
                      <div className="flex justify-between mb-2">
                        <h3 className="text-xl font-bold text-gray-900">{walker.id}. {walker.name}</h3>
...
export default FindWalkersSection;
