      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          >
            ...
            >
              Find Trusted Pet Care in Your Neighborhood
            </motion.h1>
            ...
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-sm p-4 rounded-2xl shadow-lg max-w-xl"
            >
                ...
                <div className="flex-1">
                  <div className="relative">
                    ...
                    <motion.input
                      ...
                      className="w-full bg-white/20 border border-white/30 rounded-lg py-3 pl-10 pr-4 text-white placeholder-white/70 focus:outline-none"
                    />
                  </div>
                </div>
                <div className="flex-1">
                  <div className="relative">
                    ...
                    <motion.select
                      whileFocus={{ boxShadow: "0 0 0 2px rgba(255,255,255,0.5)" }}
                      className="w-full bg-white/20 border border-white/30 rounded-lg py-3 pl-10 pr-4 text-white appearance-none focus:outline-none"
                    >
                      <option value="" className="text-gray-800">Select service</option>
                      <option value="walking" className="text-gray-800">Dog Walking</option>
                      <option value="sitting" className="text-gray-800">Pet Sitting</option>
                      <option value="boarding" className="text-gray-800">Overnight Care</option>
                    </motion.select>
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center mt-8 gap-4"
            >
              <div className="flex items-center bg-white/20 px-3 py-1.5 rounded-full">
                ...
                <span className="text-sm font-medium">4.9/5 Trusted</span>
              </div>
              <div className="flex items-center bg-white/20 px-3 py-1.5 rounded-full">
              ...
              <div className="flex items-center bg-white/20 px-3 py-1.5 rounded-full">
                <Clock className="w-4 h-4 mr-1.5 text-white" />
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -bottom-5 -left-5 bg-white rounded-xl shadow-lg p-4 max-w-xs hidden md:block"
              >
                <div className="flex items-start">
                  <img
                    src="https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8MHx8&auto=format&fit=crop&w=761&q=80"
